...
### [Pacific 327](pacific327_inventory.md) — BSL1 Molecular Laboratory
...
### [Pacific 333](pacific333_inventory.md) — Drosophila and Microscopy Lab
...
Each inventory file is organized by lab location and includes bench-level specific locations to help you find what you need before entering the lab. Please review the [Shared Lab Guidelines](IE2_Shared_Lab_Guidelines.md) before using any space. If you notice items that are missing, misplaced, or need to be added, please contact Mark Currey.
---
